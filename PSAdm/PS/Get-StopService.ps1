...
# Get-ServiceRun -ComputerName mp-hms-a01, mp-hms-a02, mp-hms-a03, mp-hms-a04 -Service *vws, vitalP*, Mckesson*
...
# Get-ServiceRun -ComputerName mp-doc-sd01, mp-spt-w04 -Service Splunk*

# Get-ServiceRun -ComputerName mp-sql-sd06 -Service Splunk*
