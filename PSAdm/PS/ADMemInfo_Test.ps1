...
(Get-ADGroupMember -Identity "iNet_Service" -Recursive | Where objectclass -eq 'user').count
Get-ADGroupMember -Identity "iNet_Service" -Recursive | Where objectclass -eq 'user' |
